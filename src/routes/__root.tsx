...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Malermeister DMW – Maler & Wandgestaltung in Fürth" },
      { name: "description", content: "Malermeister DMW aus Fürth: Hochwertige Malerarbeiten, kreative Wandgestaltung, fugenlose Oberflächen & Trockenbau. Sauber, pünktlich, meisterhaft." },
      { property: "og:title", content: "Malermeister DMW – Maler & Wandgestaltung in Fürth" },
      { property: "og:description", content: "Hochwertige Malerarbeiten, kreative Wandgestaltung und fugenlose Oberflächen in Fürth & Umgebung." },
